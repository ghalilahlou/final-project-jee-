    ...
    <div class="cart-page">
      ...
      <div class="container">
        ...
        <div class="empty-cart card">
          ...
          <a routerLink="/products" class="btn btn-primary btn-lg">Découvrir les produits</a>
        </div>
      </div>
    </div>
  `,
    styles: [`
    .cart-page { min-height: 100vh; padding: 40px 0; background: var(--gray-50); }
    ...
    .empty-cart h3 { margin-bottom: 12px; font-size: 1.5rem; }
    .empty-cart p { margin-bottom: 32px; color: var(--gray-700); }
  `]
})
